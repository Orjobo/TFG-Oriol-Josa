...
def fig_TS_plane():
    ...
    _vir = plt.cm.viridis
    ax.add_patch(plt.Rectangle((5, 5), 5, 5, fc=_vir(0.85), ec="black", alpha=0.8))
    ax.add_patch(plt.Rectangle((10, 5), 5, 5, fc=_vir(0.55), ec="black", alpha=0.8))
    ax.add_patch(plt.Rectangle((5, 0), 5, 5, fc=_vir(0.35), ec="black", alpha=0.8))
    ax.add_patch(plt.Rectangle((10, 0), 5, 5, fc=_vir(0.12), ec="black", alpha=0.8))
